...
IItem martilloDeGuerra = new Martillo("Martillo de Guerra", 15); //se crea un item con nombre Martillo de Guerra, ataque 15 y defensa 5
IItem armaduraValiriana = new Armadura("Armadura Valiriana",20); //se crea un item con nombre Armadura Valiriana, ataque 0 y defensa 20
...
SpellTome SangreDracarica = new SpellTome("Sangre Dracárica"); //se crea un SpellTome con nombre Sangre Dracárica
...
IItem capa = new Escudo("Capa Mágica", 0); //se crea un item con nombre Capa Mágica, ataque 0 y defensa 10

mago.AddItem(baston); //se añade el item Bastón Mágico a gandalf
mago.AddItem(capa); //se añade el item Capa Mágica a gandalf

SpellTome CorazonHelado = new SpellTome("Corazón Helado"); //se crea un SpellTome con nombre Corazón Helado
...
IItem bastonGigante = new Baculo("Bastón de Hielo");//se crea un item con nombre Bastón de Hielo, ataque 10 y defensa 3
IItem capain = new Capa("Capa de Sigilo", 10);//se crea un item con nombre Capa de Sigilo, ataque 0 y defensa 10
...
IItem arco = new Arco("Arco de yggdrasil", 12); //se crea un item con nombre Arco de yggdrasil, ataque 12 y defensa 0
IItem tunicaElfica = new Capa("Túnica Élfica", 8); //se crea un item con nombre Túnica Élfica, ataque 0 y defensa 8
