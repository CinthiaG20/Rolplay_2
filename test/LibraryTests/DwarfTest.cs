...
public class DwarfTest
{
    ...
    {
        Item martillo = new Item("Martillo", 15, ItemType.Attack);
    ...
    {
        Dwarf enano = new Dwarf("Enano", 100);
        Item martillo = new Item("Martillo", 10, ItemType.Attack);
        Item espada = new Item("Espada", 5, ItemType.Defense);
        Item hacha = new Item("Hacha", 0, ItemType.Attack);
