...
IAttackItem martilloDeGuerra = new Martillo("Martillo de Guerra", 15); //se crea un item con nombre Martillo de Guerra, ataque 15 y defensa 5
IDefenseItem armaduraValiriana = new Armadura("Armadura Valiriana",20); //se crea un item con nombre Armadura Valiriana, ataque 0 y defensa 20
...
IMagicItem SangreDracarica = new SpellTome("Sangre Dracárica"); //se crea un SpellTome con nombre Sangre Dracárica
...
Wizard mago = new Wizard("Gandalf", 100); //se crea un mago con nombre Gandalf, vida 100 y se le asigna el SpellTome Sangre Dracárica
mago.AddItem(SangreDracarica);
IItem baston = new Guantelete("Bastón Mágico", 10, 10); //se crea un item con nombre Bastón Mágico, ataque 10 y defensa 3
IDefenseItem capa = new Escudo("Capa Mágica", 0); //se crea un item con nombre Capa Mágica, ataque 0 y defensa 10

mago.AddItem(baston); //se añade el item Bastón Mágico a gandalf
mago.AddItem(capa); //se añade el item Capa Mágica a gandalf

IMagicItem CorazonHelado = new SpellTome("Corazón Helado"); //se crea un SpellTome con nombre Corazón Helado
...
Wizard mago1 = new Wizard("Sauron", 100); //se crea un mago con nombre Sauron, vida 100 y se le asigna el SpellTome Corazón Helado
mago.AddItem(CorazonHelado);
IMagicItem bastonGigante = new Baculo("Bastón de Hielo");//se crea un item con nombre Bastón de Hielo, ataque 10 y defensa 3
IDefenseItem capain = new Capa("Capa de Sigilo", 10);//se crea un item con nombre Capa de Sigilo, ataque 0 y defensa 10
...
IAttackItem arco = new Arco("Arco de yggdrasil", 12); //se crea un item con nombre Arco de yggdrasil, ataque 12 y defensa 0
IDefenseItem tunicaElfica = new Capa("Túnica Élfica", 8); //se crea un item con nombre Túnica Élfica, ataque 0 y defensa 8
...
mago.Attack(enano); //gandalf ataca al Gimli
...
enano.Attack(elfo); //Gimli ataca a Legolas
elfo.Attack(mago1); //Legolas ataca a Sauron
enano.Heal();